#ifndef ALASHLEDMATRIX8X8_H_
#define ALASHLEDMATRIX8X8_H_
...
class AlashLEDMatrix8x8: public Adafruit_GFX
#else
class AlashLEDMatrix8x8
#endif
{
	...
	public:
		...
		AlashLEDMatrix8x8(uint8_t N, uint8_t ssPin, uint8_t flags = 0, uint8_t* frameBuffer = nullptr);
		#ifdef USE_ADAFRUIT_GFX
		virtual
		#endif
		~AlashLEDMatrix8x8();
		...
		AlashLEDMatrix8x8(const AlashLEDMatrix8x8& other) = delete;
		AlashLEDMatrix8x8(AlashLEDMatrix8x8&& other) = delete;
		AlashLEDMatrix8x8& operator=(const AlashLEDMatrix8x8& other) = delete;
